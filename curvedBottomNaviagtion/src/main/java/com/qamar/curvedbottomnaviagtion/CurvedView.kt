...
class CurvedView @JvmOverloads constructor(
    ...
    private fun calculateInner() {
        ...
        innerArray[2] = PointF(curveX - curveInnerWidth / 4, curveInnerHeight + extra)
        innerArray[3] = PointF(curveX - curveInnerWidth / 4, height - extra)
        innerArray[4] = PointF(curveX, height - extra)
        innerArray[5] = PointF(curveX + curveInnerWidth / 4, height - extra)
        innerArray[6] = PointF(curveX + curveInnerWidth / 4, curveInnerHeight + extra)
